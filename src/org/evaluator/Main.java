...
public class Main {
    public static void main(String[] args) {
         ...
         * * if (args.length < 6) {
         * System.err.
         * println("You need to pass at least one -alt and -o argument for the program to work."
         * );
         * System.exit(1);
         * }
         * 
         * var alterationFiles = new ArrayList<Quintet<String, String, String, String,
         * String>>();
         * var outfile = "";
         * 
         * // arguments are expected to be: truth Correspondences (YAML), truthYAML,
         * truthCSV, alterationYAML, alterationCSV
         * for (var i = 0; i < args.length; i++) {
         * if (args[i].startsWith("-alt") && args.length > i + 5) {
         * alterationFiles.add(new Quintet<>(args[i + 1], args[i + 2], args[i + 3],
         * args[i + 4], args[i + 5]));
         * }
         ...
         * System.out.println("Starting analysis of " + alterationFiles.size() +
         * "schema relations.\n" +
         ...
         * var truthCorrespondences =
         * YAMLtoTruthCorrespondences.convert(input.getValue0());
         * 
         * System.out.print("\rCurrently at step " + step.getAndIncrement() + "/" + 3 *
         * alterationFiles.size());
         ...
         * Arrays.stream(truth.split("/")).reduce((first, second) ->
         * second).orElse(null),
         * Arrays.stream(alteration.split("/")).reduce((first, second) ->
         * second).orElse(null),
         * correspondences,
